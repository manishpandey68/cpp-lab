...
class garage{
    ...
    public:
        void park(){
            cout << "Enter the enter time of car(hour, minute and seconds): ";
            inTime.inputTime();
        ...
        void calculate(){
            ...
            if(hrs < 0 && days ==0){
                ...
                cout << "You have to pay $" << totalfee << endl;
                id = "";
                days = 0;
                count --;
            }
        ...
        void leave(){
            cout << "Enter the time of exit(hour, minute and seconds): ";
            outTime.inputTime();
            cout << "How many days you have parked : ";
            cin >> days;
            isVacant = true;
            calculate();
          }
